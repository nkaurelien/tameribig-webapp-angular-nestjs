...
- **Architecture**
  ...
  - [Infrastructure Docker](architecture/docker.md)

- **Backend**
  - [Modules](backend/modules.md)
  - [Base de données (CouchDB)](backend/database.md)
  - [Authentification (SuperTokens)](backend/auth.md)
  - [Stockage (MinIO)](backend/storage.md)
...
- **Migration**
  - [Rapport d'analyse](migration-analysis-report.md)
  - [État d'avancement](migration/status.md)
  - [Constitution](migration/constitution.md)
